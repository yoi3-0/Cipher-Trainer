            ...
            <Panel id={id} className='edu_one'>
                ...
                <Group style={boxStyle}>
                    {this.state.activeTab === 'methods' && <Div className='edutext'>
                        ...
                        <h3 className='headerEdu'>Тяжёлый уровень</h3>
                        <p>Прежде чем мы перейдем к обучению решению сложных обратных функций, нам сперва нужно разобраться в таком алгоритме, как алгоритм быстрого возведения в степень.
                        Алгоритмов быстрого возведения в степень несколько, но мы с вами будем пользоваться только одним: проще всего вам будет понять этот алгоритм, если вы изучите
                        следующий пример: пусть у нас есть <b>21<sup>13</sup></b>, представим <b>13<sub>10</sub></b> в двоичной форме: <b>13<sub>10</sub> = 1101<sub>2</sub></b>,
                        <b>m<sub>3</sub> = 1</b>, <b>m<sub>2</sub> = 1</b>, <b>m<sub>1</sub> = 0</b>, <b>m<sub>0</sub> = 1</b>, теперь мы можем записать <b>21<sup>13</sup></b> в следующей
                        форме: <b>21<sup>13</sup> = (((1*21<sup>m<sub>3</sub></sup>)<sup>2</sup>*21<sup>m<sub>2</sub></sup>)<sup>2</sup>*21<sup>m<sub>1</sub></sup>)<sup>2</sup>*21<sup>m<sub>0</sub></sup> =
                        (((1*21<sup>1</sup>)<sup>2</sup>*21<sup>1</sup>)<sup>2</sup>*21<sup>0</sup>)<sup>2</sup>*21<sup>1</sup> = (((1*21)<sup>2</sup>*21)<sup>2</sup>*1)<sup>2</sup>*21 = ((21<sup>2</sup>*21)<sup>2</sup>)<sup>2</sup>*21 =
                                ((441*21)<sup>2</sup>)<sup>2</sup>*21 = 85766121<sup>2</sup>*21 = 154472377739119461 = 21<sup>13</sup></b>.</p>
                        <p>Разобравшись в алгоритме, перейдем к решению сложных функций. Все сложные функции представляют собой уравнения сл. вида: <b>(x<sup>a</sup>) mod b + 1</b>. Перед началом
                        решения, нам необходимо подготовить "почву": сперва найдем обратное по умножению к <b>a</b> в кольце вычетов <b>b - 1</b>, вы уже научились это делать на предыдущем
                        уровне сложности, поэтому сразу перейдем к следующему этапу подготовки. Следующий этап заключается в том, что нам необходимо разложить <b>x<sup>a<sup>-1</sup></sup></b> по алгоритму
                        быстрого возведения в степень, представленному выше, общего уравнения для данного разложения нет, поэтому вам придется справляться самостоятельно. Закончив разложение, замените все <b>x</b>
                            на <b>x - 1</b>. Заменив иксы, вставьте <b>%b</b> после каждой операции возведения в степень, или умножения, а также в самом конце, заключая под <b>mod</b> все уравнение.
                            Перед последним <b>mod</b>'ом, вставьте <b>- 1</b>, а также вставьте <b>+ 1</b> после уравнения. Поздравляю, вы получили обратное к исходному уравнению.</p>
                    </Div>}
